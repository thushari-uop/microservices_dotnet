...
namespace Micro.Services.ShoppingCartAPI.Controllers
{
    ...
    public class CartAPIController : ControllerBase
    {
        ...
        //take all cart's item in single end point

        //3 senarios 
        //User adds first item to the cart 
        //       -create cart Header
        //       -create cart Details
        //User adds a new in the shopping cart(User already has few other items in cart)
        //        -find cart Header
        ...
        public async Task<object> EmailCartRequest([FromBody] CartDto cartDto)
        {
            try
            {
                ...
                await _messageBus.PublishMessage(cartDto, _configuration.GetValue<string>("TopicAndQueuNames:EmailShoppingCartQueue"));
                _response.Result = true;
